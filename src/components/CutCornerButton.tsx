...
export const CutCornerButton = (props:ComponentPropsWithoutRef<"button">) => {
    ...
    return(
        <button className={twMerge("bg-fuchsia-500/20 px-4 py-2 font-extrabold uppercase text-sm tracking-wide font-heading relative "
            ,className
            )}>
...
className="absolute top-0 right-0 bg-fuchsia-500/20"
>
<path
